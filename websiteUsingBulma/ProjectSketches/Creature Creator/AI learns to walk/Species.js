...
//this class stores a species of players, a species consists of players which have similar brains, similarity is determined by the sameSpecies function
class Species {
  ...
  constructor(p) {
    ...
    this.players = [];
    this.bestFitness = 0;
    this.champ;//the best player of this gen
    this.averageFitness = 0;
    this.staleness = 0; //how many generations the species has gone without an improvement
    this.rep;//the brain which represents this species and is what players are compared to, to determine if they are in this species

    //--------------------------------------------
    //coefficients for testing compatibility
    this.excessCoeff = 1;
    this.weightDiffCoeff = 2;
    this.compatibilityThreshold = 1.5;

    //if a player is passed into the constructor then set it as the champ and its brain as the rep
    if (p) {
      this.players.push(p);
